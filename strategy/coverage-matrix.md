...
| Test Type                |       playwright-ts        |    api-testing-ts    |   api-testing-java   |     movie-catalog-ui     | gatling-performance-tests | RestAssuredContractTest |  selenium-java  |
|--------------------------|:--------------------------:|:--------------------:|:--------------------:|:------------------------:|:-------------------------:|:-----------------------:|:---------------:|
...
| Negative / error paths   | ✅ login, form validation  |   ✅ 4xx responses   |   ✅ 404 responses   | ✅ form + server errors  |             -             |  ✅ 404 + error bodies  | ✅ login errors |
